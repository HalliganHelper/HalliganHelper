...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TA.headshot'
        db.add_column(u'HalliganTAAvailability_ta', 'headshot',
                      self.gf('imagekit.models.fields.ProcessedImageField')(default='headshots/None/ming.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TA.headshot'
        db.delete_column(u'HalliganTAAvailability_ta', 'headshot')
    ...
    models = {
        ...
        u'HalliganTAAvailability.ta': {
            ...
            'headshot': ('imagekit.models.fields.ProcessedImageField', [], {'default': "'headshots/None/ming.jpg'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'usr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'auth.group': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field course on 'TA'
        m2m_table_name = db.shorten_name(u'HalliganTAAvailability_ta_course')
        ...
        db.create_table(u'HalliganTAAvailability_officehours', (
            ...
            ('dayOfWeek', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field course on 'TA'
        db.delete_table(db.shorten_name(u'HalliganTAAvailability_ta_course'))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.cancelled'
        db.add_column(u'HalliganTAAvailability_request', 'cancelled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.cancelled'
        db.delete_column(u'HalliganTAAvailability_request', 'cancelled')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfficeHour.location'
        db.add_column(u'HalliganTAAvailability_officehour', 'location',
                      self.gf('django.db.models.fields.CharField')(default='118', max_length=255),
                      keep_default=False)

        # Deleting field 'TA.location'
        db.delete_column(u'HalliganTAAvailability_ta', 'location')


    def backwards(self, orm):
        # Deleting field 'OfficeHour.location'
        db.delete_column(u'HalliganTAAvailability_officehour', 'location')

        # Adding field 'TA.location'
        db.add_column(u'HalliganTAAvailability_ta', 'location',

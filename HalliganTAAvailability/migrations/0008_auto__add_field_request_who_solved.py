...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.who_solved'
        db.add_column(u'HalliganTAAvailability_request', 'who_solved',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['HalliganTAAvailability.TA'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.who_solved'
        db.delete_column(u'HalliganTAAvailability_request', 'who_solved_id')
    ...
    models = {
        ...
        u'HalliganTAAvailability.request': {
            ...
            'who_solved': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['HalliganTAAvailability.TA']", 'null': 'True'})
        },

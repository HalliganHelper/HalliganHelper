...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TA.has_updated_headshot'
        db.add_column(u'HalliganTAAvailability_ta', 'has_updated_headshot',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'TA.headshot'
        db.alter_column(u'HalliganTAAvailability_ta', 'headshot', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'TA.has_updated_headshot'
        db.delete_column(u'HalliganTAAvailability_ta', 'has_updated_headshot')


        # Changing field 'TA.headshot'
        db.alter_column(u'HalliganTAAvailability_ta', 'headshot', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100))
    ...
    models = {
        ...
        u'HalliganTAAvailability.request': {
            ...
            'who_solved': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['HalliganTAAvailability.TA']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'HalliganTAAvailability.ta': {
            ...
            'has_updated_headshot': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'headshot': ('django.db.models.fields.files.ImageField', [], {'default': "'headshots/None/ming.jpg'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'usr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'auth.group': {

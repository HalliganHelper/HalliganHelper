...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.checked_out'
        db.add_column(u'HalliganTAAvailability_request', 'checked_out',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.checked_out'
        db.delete_column(u'HalliganTAAvailability_request', 'checked_out')

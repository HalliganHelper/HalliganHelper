...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.emailed'
        db.add_column(u'HalliganTAAvailability_request', 'emailed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.emailed'
        db.delete_column(u'HalliganTAAvailability_request', 'emailed')

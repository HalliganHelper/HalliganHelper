...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoomInfo.updateTime'
        db.add_column(u'HalliganComputerAvailability_roominfo', 'updateTime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 11, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoomInfo.updateTime'
        db.delete_column(u'HalliganComputerAvailability_roominfo', 'updateTime')
